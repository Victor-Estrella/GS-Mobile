...
export default function CadastroEstoque() {
    ...
    const cadastrarEstoque = async () => {
        ...
        if (isNaN(parsedPessoas) || isNaN(parsedAgua) || alimentos.some(a => !a.nome.trim() || !a.quantidade.trim()) || roupas.some(r => !r.nome.trim() || !r.quantidade.trim()) ||
        ...
        <View style={styles.bg}>
            <View style={styles.cardInfo}>
                ...
                <ScrollView contentContainerStyle={styles.formInfo} style={{ flex: 1, width: "100%" }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    ...
                    <Botao title="CADASTRAR" onPress={cadastrarEstoque} />
                </ScrollView>
            </View>
        </View>
    );
